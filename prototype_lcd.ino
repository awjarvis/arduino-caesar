...
int Contrast = 30; // Sets contrast, needs to be 30 or it will act o a little odd
LiquidCrystal lcd(12, 11, 5, 4, 3, 2); // Assigns pins to LCD
const int buttonPin = 7; // Button pin
int lock = 0; // Button pressed var

String password = "green"; // Needs to be no greater than 8 letters
...
String shiftString(String str, int shift) { // Broken caesar cipher encryption algorithm
  String shifted = "";
